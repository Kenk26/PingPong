...
const user= createPaddle(0,canvas.height/2-paddleHeight/2,paddleWidth,paddleHeight,"AQUA");

const com = createPaddle(canvas.width-paddleWidth,canvas.height/2-paddleHeight/2,paddleWidth,paddleHeight,"aquamarine");

const ball= createBall(canvas.width/2,canvas.height/2,ballRadius,initialBallSpeed,initialBallSpeed,"rgb(115, 0, 255)");
...
function render(){
    ...
    drawText(user.score,canvas.width/4,canvas.height/2,"rgb(75, 159, 255)",120,'bold');
    drawText(com.score,(3*canvas.width)/4,canvas.height/2,"rgb(75, 159, 255)",120,'bold');
